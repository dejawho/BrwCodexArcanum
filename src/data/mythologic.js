...
export const MYTHOLOGIC_DATA = [
    {
        ...
        evocationStats: [{type: 'speed', value: 0}, {type: 'strength', value: 0}, {type: 'health', value: 3}],
        set: 'Crono',
    },
    {
        image: require('../../assets/schools/mitologica/h02.png'),
        title: 'Arco Dorato di Artemide - Artemis\' Golden Bow',
        effect: 'Evoca l\'arco dorato di Artemide. Dopo di ciò puoi infliggere 2 danni ad un bersagio entro distanza 2. L\'arco ha le seguenti caratteristiche:{evocationStats}L\'arco non è colpito da Danni ad Area. Finché possiedi l\'arco come evocazione puoi infliggere 1 danno entro distanza 2 infece di muoverti.',
        reverseEffect: 'Infliggi 4 danni al modello bersaglio',
        evocationStats: [{type: 'speed', value: 0}, {type: 'strength', value: 0}, {type: 'health', value: 2}],
        set: 'Crono',
    },
    {
    ...
    },
    {
        ...
        evocationStats: [{type: 'speed', value: 0}, {type: 'strength', value: 3}, {type: 'health', value: 4}],
        set: 'Crono',
    },
    {
        ...
        evocationStats: [{type: 'speed', value: 0}, {type: 'strength', value: 0}, {type: 'health', value: 4}],
        set: 'Crono',
    },
    {
...
export const MYTHOLOGIC_DESCRIPTION = {
    name: 'Mitologica',
